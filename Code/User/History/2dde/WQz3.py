...
def efficiencyTest(n):
    ...
    for i in range(n):
        ...
        l.append(x)
    print(l)
    return "bubble sort, sorted list + number of swaps:", bubbleSort(l.copy(), swap=True), "merge sort, sorted list + number of swaps:", mergeSort(l.copy(), swap=True)
